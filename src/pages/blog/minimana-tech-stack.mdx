...
<Author
  ...
  bio={
    <>
      ...
      , the{' '}
      <a href="https://polydraw.v1v2.io/" target="_blank">
        PolyDraw
      </a>{' '}
      app, and the{' '}
      <a href="https://manapotion.org/" target="_blank">
        Mana Potion
      </a>{' '}
      library.
    </>
...
```ts
const enemies = world.with('transform', 'model', 'animation', 'rigidBody', 'health').where(e => e.faction === 'enemies')
```
