...
As I am embarking on a journey to rewrite the codebase of my multiplayer online RPG [**MiniMana.io**](https://minimana.io/) from scratch, I wanted to take the time to share details about the tech stack I used to make the game. This article covers the current stack as well as the changes I intend to make.
