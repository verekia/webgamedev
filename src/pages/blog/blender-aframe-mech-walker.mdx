...
<AframeLogo /> [**A-Frame**](https://aframe.io/) is a web framework for building virtual reality experiences maintained
by [Diego Marcos](https://x.com/dmarcos). It is a wrapper around the popular <ThreeLogo />
[**Three.js**](https://threejs.org/) library. A-Frame's _Hello World_ looks like this:
...
<video autoPlay loop muted style={{ margin: 'auto', maxWidth: 500, borderRadius: 6, width: '100%' }}>
...
```html
<a-entity shadow="cast: true; receive: true" scale="0.5 0.5 0.5" gltf-model="mech.gltf" animation-mixer> </a-entity>
```
...
<video autoPlay loop muted style={{ margin: '24px auto 16px', maxWidth: 500, borderRadius: 6, width: '100%' }}>
...
<html>
  ...
  <body>
    <a-scene background="color: #FAFAFA">
      ...
      >
        <a-entity position="8 0 0">
          <a-entity shadow="cast: true; receive: true" scale="0.5 0.5 0.5" gltf-model="mech.gltf" animation-mixer>
          </a-entity>
        </a-entity>
      </a-entity>
      <a-entity environment="preset: yavapai; shadow: true; lighting:none;"></a-entity>
