...
There are a [lot of other game engines](https://en.wikipedia.org/wiki/List_of_game_engines) such as <DefoldLogo /> [**Defold**](https://defold.com/) (Lua), <HaxeLogo /> [**Haxe**](https://haxe.org/) (the spiritual successor of Flash) or [**GameMaker**](https://gamemaker.io/en) (GML).
