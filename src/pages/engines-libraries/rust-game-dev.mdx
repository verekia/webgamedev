...
<ProjectList
  projects={[
    { ...rust.wgpu, description: 'Cross-platform 3D library that implements WebGPU' },
    { ...rust.bevy, description: '3D Data-driven (ECS) game engine' },
    { ...rust.fyrox, description: '3D engine with a Unity-like editor (formerly rg3d)' },
    { ...rust.ambient, description: '3D multiplayer game engine' },
    { ...rust.ggez, description: '2D game engine' },
    { ...rust.macroquad, description: '2D game engine' },
    { ...rust.piston, description: '3D game engine' },
    { ...rust.amethyst, description: '2D and 3D game engine with ECS – Archived' },
  ]}
  rust
/>
...
<ProjectList
  projects={[
    { ...rust.wasmPack, description: 'Build WebAssembly packages for the browser or NPM' },
    { ...rust.trunk, description: 'WebAssembly application bundler' },
  ]}
  rust
/>
...
<ProjectList
  projects={[rust.hyper, rust.actix, rust.rocket, rust.axum, rust.warp, rust.iron, rust.tide, rust.rouille, rust.poem]}
  rust
/>
