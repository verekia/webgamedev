...
<Project {...typescript} /> is a superset of JavaScript made by Microsoft that adds types. It is a great way to catch
bugs early in development, and nowadays, there is really no reason not to use it, particularly when the configuration is
automatically handled by a framework like Next.js.
