...
- <Project
    {...projects.rapier}
    description="Rust-based via Wasm with TypeScript support (4 packages)"
  />
- <Project
    {...projects.cannonEs}
    description={
...
- <Project
    ...
    description={
      <>
        JavaScript port of the <a href="https://github.com/bulletphysics/bullet3">Bullet</a> engine,
        no NPM package
      </>
    }
  />
