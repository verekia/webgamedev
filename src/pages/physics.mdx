...
<ProjectList
  projects={[
    ...
    { ...projects.bounce, description: 'New 🌱' },
    { ...projects.crashcat, description: 'New 🌱' },
    projects.cannonEs,
    {
      ...projects.havok,
      description: (
    ...
    {
      ...projects.useCannon,
      description: 'cannon-es for React Three Fiber',
    },
    {
      ...projects.ammo,
      description: (
...
See this [**benchmark demo**](https://isaac-mason.github.io/js-physics-benchmarks/) by [Isaac Mason](https://x.com/isaac_mason_).
