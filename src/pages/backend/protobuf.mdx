...
<ProjectList
  projects={[
    projects.protobufJs,
    {
      ...
      description: 'In a "somewhat broken state". Being reworked.',
    },
    projects.tsProto,
    projects.protobufTs,
    projects.protobufEs,
...
<Todo>
  Add example, Typed Arrays, [Typed Array Buffer Schema](https://github.com/geckosio/typed-array-buffer-schema#readme)
</Todo>
