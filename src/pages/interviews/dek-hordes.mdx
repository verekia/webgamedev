...
<Streamable id="im3r7x?autoplay=1&nocontrols=1" style={{ aspectRatio: '1170/798', maxWidth: '500px' }} />
...
<Streamable id="k8vcgn?autoplay=1&nocontrols=1" style={{ aspectRatio: '16/9', maxWidth: '650px' }} />
